...
interface ThreePersonaLayoutProps {
  personas: Persona[];
...
export const ThreePersonaLayout: React.FC<ThreePersonaLayoutProps> = ({ 
  personas, 
  onPersonaClick,
  onPersonaHover,
  onPersonaLeave
